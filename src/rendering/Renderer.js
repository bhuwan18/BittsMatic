...
export class Renderer {
  ...
  #drawMachine(ctx, machine) {
    ...
    if (machine.type === "source" || machine.type === "core") {
  ...
  #machineLabel(type) {
    return { add: "A+B", subtract: "A-B", multiply: "A*B", divide: "A/B" }[type] ?? type;
  }
  ...
  #isMathMachine(machine) {
    return ["add", "subtract", "multiply", "divide"].includes(machine.type);
  }
